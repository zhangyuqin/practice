							...
							<div class="thumbnail">
								...
								<div class="caption">
									<div class="text-center">
										...
										<a class="ajax btn btn-primary" href="index.php?<?php echo $this->tpl_var['_app']; ?>-app-index-setCurrentBasic&basicid=<?php echo $basic['basicid']; ?>" title="<?php echo $basic['basic']; ?>">已开通,去学习</a>
										<?php } else { ?>
											...
											<?php } else { ?>
												...
												<?php } else { ?>
												<a class="btn" href="javascript:;" title="<?php echo $basic['basic']; ?>">暂缓开通</a>
												<?php } ?>
											<?php } ?>
										<?php } ?>
										</p>
