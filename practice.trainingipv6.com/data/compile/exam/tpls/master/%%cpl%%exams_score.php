...
<?php } ?>
 ...
 $bid++; ?>
					...
					<!-- 	<td>
						...
						<td>
							<div class="btn-group">
								<a class="btn" href="index.php?exam-master-exammanager-scorelist&page=<?php echo $this->tpl_var['page']; ?>&basicid=<?php echo $basic['basicid']; ?><?php echo $this->tpl_var['u']; ?>" title="成绩统计"><em class="icon-edit"></em></a>
