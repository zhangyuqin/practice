...
<?php } ?>
 ...
 $aid++; ?>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="radio inline">
								<input name="args[basicbuy]" type="radio" value="1" <?php if($this->tpl_var['basic']['basicbuy']){ ?>checked<?php } ?>/>是
							</label>
							<label class="radio inline">
								<input name="args[basicbuy]" type="radio" value="0" <?php if(!$this->tpl_var['basic']['basicbuy']){ ?>checked<?php } ?>/>否
							</label>
						</div>
					</div>
					<div class="control-group">
