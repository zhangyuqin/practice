...
<?php } ?>
 ...
 $tid++; ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="args[basicexam][opentime][start]" type="text" value="<?php if($this->tpl_var['basic']['basicexam']['opentime']['start']){ ?><?php echo $this->tpl_var['basic']['basicexam']['opentime']['start']; ?><?php } else { ?>0<?php } ?>" needle="needle" msg="您必须输入一个开启时间起点" /> - <input name="args[basicexam][opentime][end]" type="text" value="<?php if($this->tpl_var['basic']['basicexam']['opentime']['end']){ ?><?php echo $this->tpl_var['basic']['basicexam']['opentime']['end']; ?><?php } else { ?>0<?php } ?>" needle="needle" msg="您必须输入一个开启时间终点" />
