				...
				<fieldset>
					...
					<div class="logcontrol">
						<div class="control-group">
							...
							<div class="controls">
								<input class="input-xlarge" type="text" name="args[username]" datatype="userName" needle="needle" msg="请你输入用户名"/><span>请输入可用的用户名</span>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="randCode" type="text" size="4" style="width:auto;" name="randcode"/>
								<img src="index.php?core-api-randcode" class="randCode img-rounded"/>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
								<input class="input-xlarge" type="checkbox" name="serviceterm" value="1" needle="needle" msg="请选择IPv6论坛认证网络工程师注册协议" checked/><span>我已阅读并同意<a href="index.php?user-app-serviceterm" target="_blank">《IPv6论坛认证网络工程师注册协议》</a></span>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
						...
						<div class="control-group">
							<div class="controls">
								<p>如果您已有帐号，请在此<a href="index.php?user-app-login">登录</a></p>
							</div>
						</div>
					</div>
				</fieldset>
