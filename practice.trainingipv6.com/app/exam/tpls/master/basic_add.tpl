...
{x2;endif}
			...
			<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="radio inline">
							<input name="args[basicbuy]" type="radio" value="1" {x2;if:$basic['basicbuy']}checked{x2;endif}/>是
						</label>
						<label class="radio inline">
							<input name="args[basicbuy]" type="radio" value="0" {x2;if:!$basic['basicbuy']}checked{x2;endif}/>否
						</label>
					</div>
				</div>
				<div class="control-group">
