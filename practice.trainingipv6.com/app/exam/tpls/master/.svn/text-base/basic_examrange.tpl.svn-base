...
{x2;endif}
	        ...
	        <form action="?exam-master-basic-setexamrange" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="args[basicexam][opentime][start]" type="text" value="{x2;if:$basic['basicexam']['opentime']['start']}{x2;$basic['basicexam']['opentime']['start']}{x2;else}0{x2;endif}" needle="needle" msg="您必须输入一个开启时间起点" /> - <input name="args[basicexam][opentime][end]" type="text" value="{x2;if:$basic['basicexam']['opentime']['end']}{x2;$basic['basicexam']['opentime']['end']}{x2;else}0{x2;endif}" needle="needle" msg="您必须输入一个开启时间终点" />
