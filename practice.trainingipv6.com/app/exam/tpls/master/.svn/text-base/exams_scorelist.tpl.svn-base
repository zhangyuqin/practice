...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-master-exammanager-score">成绩管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a class="ajax" href="index.php?{x2;$_app}-master-exammanager-outscore&basicid={x2;$basicid}">导出成绩</a>
				</li>
			</ul>
