...
{x2;endif}
			<ul class="breadcrumb">
				...
				<!-- <li><a href="index.php?{x2;$_app}-teach-users">开通课程</a> <span class="divider">/</span></li> -->
			...
			<!-- 	<li class="dropdown pull-right">
					<a href="index.php?{x2;$_app}-teach-users">开通课程</a>
				</li> -->
			</ul>
	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
					...
					<!-- 	<td>
						...
						<td>
							{x2;if:v:basic['basicopen']}<a class="ajax btn" title="关闭考场" href="index.php?exam-teach-users-closebasics&basicid={x2;v:basic['basicid']}"><em class="icon-minus-sign"></em></a>{x2;else}<a class="ajax btn" href="index.php?exam-teach-users-openbasics&basicid={x2;v:basic['basicid']}" title="开启考场"><em class="icon-plus-sign"></em></a>{x2;endif}
						</td>
			        </tr>
			        {x2;endtree}
	        	</tbody>
