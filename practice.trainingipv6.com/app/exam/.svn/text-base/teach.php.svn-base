...
class app
{
	...
	public function users()
	{
		...
		switch($subaction)
		{
		    ...
		    $this->tpl->display('users_courses');
		    break;
		    ...
		    else
		    {
		        ...
		        $this->basic->openBasic($basicid);
		        $message = array(
		            'statusCode' => 200,
		            "message" => "开通成功",
		            "callbackType" => "forward",
		            "forwardUrl" => "index.php?exam-teach-users-basics"
		        );
		    }
		    exit(json_encode($message));
		    break;
		    ...
		    $this->basic->delOpenBasic($basicid);
		    $message = array(
		        'statusCode' => 200,
		        "message" => "考场已关闭",
		        "callbackType" => "forward",
		        "forwardUrl" => "index.php?exam-teach-users-basics&userid={$ob['obuserid']}&page={$page}{$u}"
		    );
		    exit(json_encode($message));
		    break;
